  ...
  return (
    <section className="relative w-full h-screen mx-auto overflow-hidden">
      ...
      <div className="absolute inset-0 z-10 flex flex-col md:flex-row items-center justify-between pointer-events-none max-w-7xl mx-auto px-6 lg:px-8 pt-20">
        ...
        >
          <div className="w-[280px] h-[280px] xl:w-[380px] xl:h-[380px] relative flex items-center justify-center mt-auto mb-10 lg:mb-20 rounded-full border-[6px] border-neon-cyan shadow-[0_0_30px_rgba(0,240,255,0.6),inset_0_0_20px_rgba(0,240,255,0.4)] overflow-hidden transition-transform duration-500 hover:scale-105 hover:border-neon-purple hover:shadow-[0_0_40px_rgba(176,38,255,0.8),inset_0_0_20px_rgba(176,38,255,0.4)]">
             <img src="/assets/kamesh-profile.jpg" alt="Kamesh" className="w-full h-full object-cover filter brightness-105 contrast-105" />
          </div>
        </motion.div>
      </div>
