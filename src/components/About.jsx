      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 mt-16 flex flex-col md:flex-row items-center gap-10 relative z-10">
        ...
        >
          ...
          <p className="mt-4 text-gray-300 text-[17px] max-w-3xl leading-[30px]">
            I'm a skilled full-stack developer with experience in React, Node.js, Python, and Java. 
            I have a strong foundation in modern web technologies including HTML, CSS, JavaScript, and Three.js for 3D graphics. 
          ...
          <div className="mt-10 flex flex-wrap gap-4">
            {['React', 'Node.js', 'Python', 'Three.js'].map((skill) => (
        ...
        <div className="flex-1 h-[500px] w-full relative">
          <Canvas camera={{ position: [0, 0, 5], fov: 45 }}>
            <Suspense fallback={<CanvasLoader />}>
              ...
              <FloatingBadge position={[2.5, -1.5, 0]} text="Node.js" color="#b026ff" />
